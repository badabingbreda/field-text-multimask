      ...
      $field_types['multimask'] = [
        ...
        'controls' => [
          ...
          \MBB\Control::Select(
            'store',
              [
                'label'   => __( 'Store value as', 'your-text-domain' ),
                'tooltip' => __( 'Caution: storing masked values prohibits you from doing calculations with the field value. Storing as Unmasked Value is adviced. If you select Masked Value, the field will be returned as displayed in the multimask field.', 'your-text-domain' ),
                'options' => [
                  'value'  => __( 'Masked Value', 'your-text-domain' ),
                  'unmaskedValue'  => __( 'Unmasked Value', 'your-text-domain' ),
                ],
                'dependency' => '', // 'custom_layout:true',
              ],
              'unmaskedValue',    // default value
